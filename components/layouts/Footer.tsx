    ...
    <footer className="bg-slate-900 text-white border-t border-slate-800">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* COLUMN 2: SECTIONS */}
          <div>
            <h3 className="text-sm font-bold text-gray-200 tracking-wider uppercase mb-4">{t('Sections')}</h3>
          ...
          {/* COLUMN 3: COMPANY */}
          <div>
            <h3 className="text-sm font-bold text-gray-200 tracking-wider uppercase mb-4">{t('Support Independent News')}</h3>
            <ul className="space-y-3">
          ...
          {/* COLUMN 4: NEWSLETTER */}
          <div>
            <h3 className="text-sm font-bold text-gray-200 tracking-wider uppercase mb-4">{t('Briefing')}</h3>
            <p className="text-xs text-gray-400 mb-4">
              {t('Sign up for our weekly dispatch.')}
            </p>
